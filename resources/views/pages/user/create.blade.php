                    ...
                    <div class="card card-info">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    {!! Form::text('username', old("username"),['placeholder' => 'Enter username', 'class' => ['form-control' ,($errors->has('username')?'is-invalid':'')]]) !!}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    {!! Form::email('email', old("email"),  ['placeholder' => 'Enter Email', 'class' => ['form-control' ,($errors->has('email')?'is-invalid':'')]]) !!}
                                    @if ($errors->has('email'))
                                        <span class=" invalid-feedback" role="alert">
